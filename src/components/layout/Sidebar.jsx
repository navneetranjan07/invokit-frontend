...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-gray-900 flex flex-col min-h-screen shrink-0">
      ...
      <div className="px-6 py-5 border-b border-gray-700/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-500 text-xs mt-0.5">Invoice Manager</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-gray-700/50">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg
                     text-sm text-gray-400 hover:text-red-400 hover:bg-gray-800
